  ...
  <div className="h-screen flex overflow-hidden bg-gray-100">
    ...
    <div x-show="sidebarOpen" className="md:hidden">
      ...
      <div className="fixed inset-0 flex z-40">
        <div
          x-show="sidebarOpen"
          className="flex-1 flex flex-col max-w-xs w-full bg-indigo-800 transform ease-in-out duration-300 "
        >
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 px-2">
              ...
              <Link href="/team">
                <a className="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-indigo-300 hover:text-white hover:bg-indigo-700 focus:outline-none focus:text-white focus:bg-indigo-700 transition ease-in-out duration-150">
                  <svg
                    className="mr-4 h-6 w-6 text-indigo-400 group-hover:text-indigo-300 group-focus:text-indigo-300 transition ease-in-out duration-150"
                    stroke="currentColor"
                    fill="none"
          ...
          <a href="#" className="flex-shrink-0 group block focus:outline-none">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs leading-4 font-medium text-indigo-300 group-hover:text-indigo-100 group-focus:underline transition ease-in-out duration-150">
                  View profile
                </p>
              </div>
            </div>
